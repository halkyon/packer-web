...
echo 'deb http://mirror.aarnet.edu.au/pub/MariaDB/repo/10.0/debian jessie main' > /etc/apt/sources.list.d/mariadb.list
echo 'deb-src http://mirror.aarnet.edu.au/pub/MariaDB/repo/10.0/debian jessie main' >> /etc/apt/sources.list.d/mariadb.list
